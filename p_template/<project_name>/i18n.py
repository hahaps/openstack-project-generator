...
from <project_name>.openstack.common import gettextutils
...
# oslo-incubator. Until these parts are changed to use oslo.i18n, <Project_name>
# needs to do something to allow them to work. One option is to continue to
# initialize gettextutils, but with the way that <Project_name> has initialization
