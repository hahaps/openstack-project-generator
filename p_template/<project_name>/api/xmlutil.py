...
XMLNS_V10 = 'https://www.openstack.org/mediawiki/<project_name>/api/v1.0'
XMLNS_V11 = 'https://www.openstack.org/mediawiki/<project_name>/api/v1.0'
XMLNS_COMMON_V10 = 'https://www.openstack.org/mediawiki/<project_name>/api/v1.0'
XMLNS_ATOM = 'http://www.w3.org/2005/Atom'
XMLNS_<PROJECT_NAME>_V1 = ('https://www.openstack.org/mediawiki/<project_name>/1.0/content')
...
def validate_schema(xml, schema_name):
    ...
    base_path = '<project_name>/api/schemas/v1.1/'
    if schema_name in ('atom', 'atom-link'):
        base_path = '<project_name>/api/schemas/'
    schema_path = os.path.join(utils.<project_name>dir(),
