...
api_common_opts = [
    ...
    cfg.StrOpt('osapi_<project_name>_base_URL',
               default=None,
               help='Base URL that will be presented to users in links '
                    'to the OpenStack <Project_name> API',
...
def get_sort_params(params, default_key='created_at', default_dir='desc'):
    ...
    :param params: webob.multidict of request parameters (from
                   <project_name>.api.openstack.wsgi.Request.params)
...
def remove_version_from_href(href):
    ...
    Given: 'http://www.<project_name>.com/v1.1/123'
    Returns: 'http://www.<project_name>.com/123'

    Given: 'http://www.<project_name>.com/v1.1'
    Returns: 'http://www.<project_name>.com'
...
class ViewBuilder(object):
    ...
    def _get_next_link(self, request, identifier, collection_name):
        ...
        prefix = self._update_link_prefix(get_request_url(request),
                                          CONF.osapi_<project_name>_base_URL)
        url = os.path.join(prefix,
                           request.environ["<project_name>.context"].project_id,
                           collection_name)
