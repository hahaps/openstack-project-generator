...
# for <project_name>.tests modules
...
ignore_messages = ["An attribute affected in <project_name>.tests",
...
# checked elsewhere. We also ignore <project_name>.tests for now due to high false
# positive rate.
ignore_modules = ["<project_name>/openstack/common/", "<project_name>/tests/"]

# Note(thangp): E0213, E1101, and E1102 should be ignored for only
# <project_name>.object modules. E0213 and E1102 are error codes related to
...
# the <project_name> code base using objects. E1120 is an error code related no value
...
objects_ignore_messages = [
    ...
    "Module '<project_name>.objects' has no 'Snapshot' member",
    "Module '<project_name>.objects' has no 'SnapshotList' member",
    "Module '<project_name>.objects' has no 'Backup' member",
    "Module '<project_name>.objects' has no 'BackupList' member",
    "Module '<project_name>.objects' has no 'Service' member",
    "Module '<project_name>.objects' has no 'ServiceList' member",
    "Module '<project_name>.objects' has no 'BackupImport' member",
    "Module '<project_name>.objects' has no 'ConsistencyGroup' member",
    "Module '<project_name>.objects' has no 'ConsistencyGroupList' member",
]
objects_ignore_modules = ["<project_name>/objects/"]
...
def run_pylint():
    ...
    args = ["--include-ids=y", "-E", "<project_name>"]
