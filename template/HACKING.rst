<Project_name> Style Commandments
=========================
...
<Project_name> Specific Commandments
----------------------------
...
<Project_name> is transitioning to use mock, rather than mox, and so new tests should
use mock only.

For more information on creating unit tests and utilizing the testing
infrastructure in OpenStack <Project_name>, please read the <Project_name> testing
