...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = <project_name>.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import <project_name>.api.fancy_api
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = <project_name>.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import <project_name>.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `<project_name>.exception.PasteAppNotFound`
