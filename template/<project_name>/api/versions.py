...
from <project_name>.api.views import versions as views_versions
        ...
        "media-types": [
            {
                ...
                "type": "application/vnd.openstack.<project_name>+xml;version=1",
            },
            {
                "base": "application/json",
                "type": "application/vnd.openstack.<project_name>+json;version=1",
            }
        ],
    }
}
...
class <Project_name>Version(object):
...
def create_resource():
    return wsgi.Resource(<Project_name>Version())
