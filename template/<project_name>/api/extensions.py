...
import <project_name>.api.openstack
from <project_name>.api.openstack import wsgi
from <project_name>.api import xmlutil
from <project_name> import exception
from <project_name>.i18n import _LE, _LI, _LW
...
class ExtensionDescriptor(object):
    ...
    def __init__(self, ext_mgr):
        """R<project_name>ter extension with the extension manager."""
...
class ExtensionManager(object):
    ...
    See <project_name>/tests/api/extensions/foxinsocks/extension.py for an
    ...
    def __init__(self):
        ...
        self.cls_list = CONF.osapi_<project_name>_extension
        self.extensions = {}
...
class ControllerExtension(object):
    """Extend core controllers of <project_name> OpenStack API.

    Provide a way to extend existing <project_name> OpenStack API core
    controllers.
    """
...
def load_standard_extensions(ext_mgr, logger, path, package, ext_list=None):
    """R<project_name>ters all standard API extensions."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None, action=None):
        ...
        <project_name>.policy.enforce(context, act, target)
    return authorize
