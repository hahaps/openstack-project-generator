...
from <project_name>.i18n import _, _LE, _LI
from <project_name> import utils
from <project_name>.wsgi import common as wsgi


XML_NS_V1 = 'https://www.openstack.org/mediawiki/<Project_name>/1.0/content'
...
SUPPORTED_CONTENT_TYPES = (
    'application/json',
    'application/vnd.openstack.<project_name>+json',
    'application/xml',
    'application/vnd.openstack.<project_name>+xml',
)

_MEDIA_TYPE_MAP = {
    'application/vnd.openstack.<project_name>+json': 'json',
    'application/json': 'json',
    'application/vnd.openstack.<project_name>+xml': 'xml',
    'application/xml': 'xml',
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if '<project_name>.best_content_type' not in self.environ:
            ...
            self.environ['<project_name>.best_content_type'] = (content_type or
                                                      'application/json')

        return self.environ['<project_name>.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def register_actions(self, controller):
        """R<project_name>ters controller actions with this resource."""
    ...
    def register_extensions(self, controller):
        """R<project_name>ters controller extensions with this resource."""
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('<project_name>.context')
...
def _set_request_id_header(req, headers):
    context = req.environ.get('<project_name>.context')
    if context:
