...
from <project_name>.wsgi import common as base_wsgi
...
class InjectContext(base_wsgi.Middleware):
    """Add a '<project_name>.context' to WSGI environ."""
    ...
    def __call__(self, req):
        req.environ['<project_name>.context'] = self.context
        return self.application


class <Project_name>KeystoneContext(base_wsgi.Middleware):
