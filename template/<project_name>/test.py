...
from <project_name>.common import config  # noqa Need to register global_opts
from <project_name>.db import migration
from <project_name>.db.sqlalchemy import api as sqla_api
...
from <project_name>.tests import fixtures as <project_name>_fixtures
from <project_name>.tests.unit import conf_fixture
from <project_name>.tests.unit import fake_notifier
...
class TestCase(testtools.TestCase):
    ...
    def start_service(self, name, host=None, **kwargs):
        ...
        kwargs.setdefault('binary', '<project_name>-%s' % name)
