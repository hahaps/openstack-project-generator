...
class LimiterTest(test.TestCase):
    """Unit tests for the `<project_name>.api.common.limited` method.
...
class PaginationParamsTest(test.TestCase):
    """Unit tests for `<project_name>.api.common.get_pagination_params` method.
...
class LinkPrefixTest(test.TestCase):
    def test_update_link_prefix(self):
        ...
        result = vb._update_link_prefix("http://192.168.0.243:24/",
                                        "http://127.0.0.1/<project_name>")
        self.assertEqual("http://127.0.0.1/<project_name>", result)
