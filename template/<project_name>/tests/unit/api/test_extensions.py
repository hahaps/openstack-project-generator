...
class ExtensionTestCase(test.TestCase):
    def setUp(self):
        ...
        ext_list = CONF.osapi_<project_name>_extension[:]
        fox = ('<project_name>.tests.unit.api.extensions.foxinsocks.Foxinsocks')
        if fox not in ext_list:
            ext_list.append(fox)
            self.flags(osapi_<project_name>_extension=ext_list)
