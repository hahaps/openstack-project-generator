...
from <project_name>.api.middleware import auth
from <project_name>.api.middleware import fault
from <project_name>.api.openstack import wsgi as os_wsgi
from <project_name>.api import urlmap
...
class HTTPRequest(webob.Request):
    ...
    def blank(cls, *args, **kwargs):
        ...
        out.environ['<project_name>.context'] = FakeRequestContext(
            'fake_user',
            'fakeproject',
